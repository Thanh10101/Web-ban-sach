        ...
        <div class="container">
            ...
            <?php 
              ...
              $row=json_decode($string);
                ...
                echo          '  <a href="http://localhost:8080/Project/Logined/Dangnhap/">';
            ...
            <div class="row">
                ...
                <div class="col-sm-7">
                    <div class="gioiThieuBookStore">
                        <h2>Giới thiệu</h2>
                        <p>
                           Trang web bán sách là nhà sách Trực tuyến
                        </p>
                        <div class="btn-sec">
                            <a href="DanhMucSanPham.html" class="btn yellow">Sách hay</a>
                            <a href="http://localhost:8080/Project/Logined/Dangnhap" class="btn black">Đăng nhập</a>
                        </div>
                    </div>
                </div>
            </div>
